...
public class SearchFXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        MyUtils.populateColumnNames(cmbSc, "hotel_menu");
        txtSi.setText(si);
    ...
    private void refreshTbl() {
        LinkedList<Menu> res = MenuDAO.search(cmbSc.getValue().toString(), txtSi.getText());
        MyUtils.populateTable(tblList, res, Menu.class);
    }
